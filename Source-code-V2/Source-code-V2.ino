/*
  IWS base code V2, which also includes Light level sensor and DHT22
  based on Arduino built-in example Web server examples
  WARNING! This script does NOT protect from multiple requests at a time, thus the DHT could return wrong data!
...
float Temperature, Pressure, ApproxAltitude, RainLevel, LightLevel, TemperatureDHT, Humidity;
